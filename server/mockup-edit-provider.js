...
export function buildMockupEditPrompt(instruction = '', optionsInput = {}) {
  ...
  return [
    ...
    'Do not translate or intentionally rewrite wording. Do not translate or rewrite wording in any way. Do not invent letters. Do not recolor logos. Do not replace illustrations or photographic subjects. Do not add brand elements that are absent from Image 1.',
